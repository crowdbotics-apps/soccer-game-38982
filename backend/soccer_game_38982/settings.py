"""
Django settings for soccer_game_38982 project.
...
ROOT_URLCONF = 'soccer_game_38982.urls'
...
WSGI_APPLICATION = 'soccer_game_38982.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soccer_game_38982 API",
    "DESCRIPTION": "API documentation for soccer_game_38982 App",
    "VERSION": "v1",
}
